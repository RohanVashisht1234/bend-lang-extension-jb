...
import com.rohanvashisht.bend.language.psi.BendFileHeader;
...
public class BendFileHeaderImpl extends ASTWrapperPsiElement implements BendFileHeader {

  public BendFileHeaderImpl(@NotNull ASTNode node) {
    super(node);
  }
