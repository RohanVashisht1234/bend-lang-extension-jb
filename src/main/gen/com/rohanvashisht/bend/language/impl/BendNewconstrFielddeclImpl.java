...
public class BendNewconstrFielddeclImpl extends ASTWrapperPsiElement implements BendNewconstrFielddecl {

  public BendNewconstrFielddeclImpl(@NotNull ASTNode node) {
    super(node);
  }
