...
import com.rohanvashisht.bend.language.psi.BendKindSignature;
...
public class BendKindSignatureImpl extends ASTWrapperPsiElement implements BendKindSignature {

  public BendKindSignatureImpl(@NotNull ASTNode node) {
    super(node);
  }
