...
public class BendConstr1Impl extends ASTWrapperPsiElement implements BendConstr1 {

  public BendConstr1Impl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<BendFielddecl> getFielddeclList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, BendFielddecl.class);
  }
