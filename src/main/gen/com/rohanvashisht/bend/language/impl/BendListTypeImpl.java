...
import com.rohanvashisht.bend.language.psi.BendListType;
...
public class BendListTypeImpl extends ASTWrapperPsiElement implements BendListType {

  public BendListTypeImpl(@NotNull ASTNode node) {
    super(node);
  }
